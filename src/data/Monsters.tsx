...
import Vauren from '../assets/images/Inimigos DnD/Vauren.png'
import Basso from '../assets/images/Inimigos DnD/Basso.png'
import Scavolth from '../assets/images/Inimigos DnD/Scavolth.png'
export const Monsters = [
    ...
    { id: 3, name: "Banshee", hp: 58, maxHp: 58, ac: 12, stats: { str: 1, dex: 14, con: 10, int: 12, wis: 11, cha: 17 }, resist:'ácido, eletrico, igneo, trovão, armas não magicas', imunite:'frio, necrotico, venenoso, exaustão, agarrão, amedrontamento,paralisia...', image: Banshee },
    ...
    { id: 7, name: "Cryovain", hp: 133, maxHp: 180, ac: 18, stats: { str: 18, dex: 10, con: 18, int: 16, wis: 15, cha: 19 },resist:'fraco contra radiante',imunite:'frio, necrotico, medo, controle mental',  image: Cryovain },
    ...
    { id: 14, name: "Gorthok the Thunder Boar", hp: 73, maxHp: 73, ac: 15, stats: { str: 20, dex: 10, con: 19, int: 6, wis: 10, cha: 14 }, resist:'armas não magicas', imunite:'elétrico, trovão', image: Gorthok },
    ...
    { id: 17, name: "Invisible Stalker", hp: 104, maxHp: 104, ac: 14, stats: { str: 16, dex: 19, con: 14, int: 10, wis: 15, cha: 11 }, resist:'armas não magica', imunite:'veneno e controle fisico', image: InvisibleStalker },
    { id: 18, name: "Mantícora", hp: 68, maxHp: 68, ac: 14, stats: { str: 17, dex: 16, con: 17, int: 7, wis: 12, cha: 8 }, image: Manticora },
    { id: 19, name: "Mimic", hp: 58, maxHp: 58, ac: 12, stats: { str: 17, dex: 12, con: 15, int: 5, wis: 13, cha: 8 }, imunite:'ácido', image: Mimic },
    ...
    { id: 30, name: "Will-o-Wisp", hp: 22, maxHp: 22, ac: 19, stats: { str: 1, dex: 28, con: 10, int: 13, wis: 14, cha: 11 }, imunite:'elétrico, veneno', resist:'ácido, trovão, igneo, necrotico e não magicas', image: WilloWisp },
    ...
    { id: 33, name: "Vauren", hp: 120, maxHp: 120, ac: 18, stats: { str: 20, dex: 10, con: 18, int: 12, wis: 8, cha: 18 }, resist:'necrotico, cortante', image: Vauren },
    { id: 34, name: "Peché Basso", hp: 85, maxHp: 85, ac: 16, stats: { str: 16, dex: 14, con: 18, int: 14, wis:12, cha: 16 }, imunite:'controle mental, medo', resist:'fogo', image: Basso },
    { id: 35, name: "Scavolth", hp:80, maxHp: 80, ac: 17, stats: { str: 17, dex: 14, con: 16, int:12, wis:14, cha: 13 }, imunite:'veneno', resist:'fogo', image: Scavolth },
];